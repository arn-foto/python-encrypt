...
#result
Entry(root, font = 'arial 10 bold', textvariable = Result, bg ='ghost white', width = 25).place(x=290, y = 150)

#result button
Button(root, font = 'arial 10 bold', text = 'RESULT'  ,padx =2,bg ='LightGray' ,command = Mode).place(x=60, y = 150)

#reset button
Button(root, font = 'arial 10 bold' ,text ='RESET' ,width =6, command = Reset,bg = 'purple', padx=2).place(x=80, y = 190)

#exit button
Button(root, font = 'arial 10 bold',text= 'EXIT' , width = 6, command = Exit,bg = 'yellow', padx=2, pady=2).place(x=180, y = 190)
root.mainloop()
